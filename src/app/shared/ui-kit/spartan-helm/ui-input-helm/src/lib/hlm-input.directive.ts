...
export const inputVariants = cva(
	'flex rounded-md border font-normal border-input  text-sm ring-offset-background file:border-0 file:text-foreground file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
	{
		variants: {
			size: {
			...
			error: {
				...
				true: 'text-red border-red focus-visible:ring-destructive',
			},
			ghost: {
				auto: '',
				true: ''
